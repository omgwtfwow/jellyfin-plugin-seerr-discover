(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      .seerr-discover-tab-content {
        --seerr-tab-top-offset: calc(7.5em + env(safe-area-inset-top));
        box-sizing: border-box;
        min-height: 100%;
        padding:
        ...
        <div class="cardBox cardBox-bottompadded seerr-card__box">
          <div class="cardScalable seerr-card__scalable">
            ...
            <span class="cardImageContainer coveredImage cardContent seerr-card__image${imageClass}" role="img" aria-label="${escapeHtml(title)}"${imageStyle}>
              ...
              ${statusBadge ? `<span class="seerr-card__badges">${statusBadge}</span>` : ''}
            </span>
          </div>
  ...
  window.addEventListener('seerrdiscoverconfigchanged', () => {
